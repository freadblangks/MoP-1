...
namespace WorldPackets
{
    namespace BattlePay
    {
        ...
        {
        public:
            BattlePayPurchaseDetails() : ServerPacket(SMSG_BATTLE_PAY_VAS_BNET_TRANSFER_VALIDATION_RESULT, 20) { }
        ...
        {
        public:
            BattlePayPurchaseUnk() : ServerPacket(SMSG_BATTLE_PAY_BUNDLE_PRICE_UPDATE, 20) { }
        ...
        public:
            ...
            BattlePayPurchaseUnkResponse(WorldPacket&& packet) : ClientPacket(CMSG_BATTLE_PAY_REQUEST_CURRENT_VAS_TRANSFER_QUEUES, std::move(packet)) { }
        ...
        {
        public:
            // opcion1 SMSG_BATTLE_PAY_VAS_TRANSFER_QUEUE_STATUS
            // opcion2 SMSG_BATTLE_PAY_VAS_CHARACTER_QUEUE_STATUS
            BattlepayUnk(uint32 unkInt) : ServerPacket(SMSG_BATTLE_PAY_VAS_TRANSFER_QUEUE_STATUS, 4), UnkInt(unkInt) { }
